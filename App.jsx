...
async function sbInsertLead(l){var body=JSON.stringify({id:l.id,nombre:l.nombre,instagram:l.instagram||"",telefono:l.telefono||"",origen:l.origen||"instagram",estado:l.estado||"nuevo",interes:l.interes||"indefinido",ultima_interaccion:l.ultimaInteraccion||null,proximo_seguimiento:l.proximoSeguimiento||null,accion_pendiente:l.accionPendiente||"",notas:l.notas||""});await fetch(SUPABASE_URL+"/rest/v1/fertil_leads",{method:"POST",headers:sbHeaders,body:body});}
